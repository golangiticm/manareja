...
class WeddingResource extends Resource
{
    ...
    protected static ?string $pluralModelLabel = 'Daftar WEDDING';
                            ...
                            Card::make()
                                ->schema([
                                    ...
                                    Forms\Components\TextInput::make('title')
                                        ->label('Judul Program')
                                        ->maxLength(255)
                                        // ->default(fn($livewire) => $livewire instanceof \Filament\Resources\Pages\CreateRecord ? 'Program WEDDING' : null)
                                        // ->live(onBlur: true)
