...
class ProgramResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'BAPTISM';

    protected static ?string $pluralModelLabel = 'Daftar BAPTISM';
                            ...
                            Card::make()
                                ->schema([
                                    ...
                                    Forms\Components\TextInput::make('title')
                                        ->label('Judul Program')
                                        ->maxLength(255)
                                        // ->default(fn($livewire) => $livewire instanceof \Filament\Resources\Pages\CreateRecord ? 'Program BAPTISM' : null)
                                        // ->live(onBlur: true)
