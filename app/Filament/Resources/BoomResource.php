...
use App\Filament\Resources\BoomResource\Pages;
use App\Filament\Resources\BoomResource\RelationManagers;
use App\Models\Boom;
...
class BoomResource extends Resource
{
    protected static ?string $model = Service::class;

    // protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $navigationLabel = 'BOOM';

    protected static ?string $navigationGroup = 'Jadwal Ibadah';

    protected static ?string $modelLabel = 'BOOM';

    protected static ?string $pluralModelLabel = 'Daftar BOOM';
    ...
    {
        return [
            'index' => Pages\ListBooms::route('/'),
            'create' => Pages\CreateBoom::route('/create'),
            'edit' => Pages\EditBoom::route('/{record}/edit'),
        ];
    }
