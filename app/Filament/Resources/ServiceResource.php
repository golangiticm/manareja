...
class ServiceResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Ibadah Raya';

    protected static ?string $navigationGroup = 'Jadwal Ibadah';

    protected static ?string $modelLabel = 'Ibadah Raya';

    protected static ?string $pluralModelLabel = 'Daftar Ibadah Raya';
