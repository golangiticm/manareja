...
use App\Filament\Resources\MogResource\Pages;
use App\Filament\Resources\MogResource\RelationManagers;
use App\Models\Mog;
...
class MogResource extends Resource
{
    protected static ?string $model = Service::class;

    // protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $navigationLabel = 'Messenger of God';

    protected static ?string $navigationGroup = 'Jadwal Ibadah';

    protected static ?string $modelLabel = 'Messenger of God';

    protected static ?string $pluralModelLabel = 'Daftar Messenger of God';
    ...
    {
        return [
            'index' => Pages\ListMogs::route('/'),
            'create' => Pages\CreateMog::route('/create'),
            'edit' => Pages\EditMog::route('/{record}/edit'),
        ];
    }
