...
use App\Filament\Resources\WbiResource\Pages;
use App\Filament\Resources\WbiResource\RelationManagers;
...
class WbiResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Wanita Bethel Indonesia';

    protected static ?string $navigationGroup = 'Jadwal Ibadah';

    protected static ?string $modelLabel = 'Wanita Bethel Indonesia';

    protected static ?string $pluralModelLabel = 'Daftar Wanita Bethel Indonesia';
    ...
    {
        return [
            'index' => Pages\ListWbis::route('/'),
            'create' => Pages\CreateWbi::route('/create'),
            'edit' => Pages\EditWbi::route('/{record}/edit'),
        ];
    }
