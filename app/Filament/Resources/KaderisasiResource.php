...
use App\Filament\Resources\KaderisasiResource\Pages;
use App\Filament\Resources\KaderisasiResource\RelationManagers;
...
class KaderisasiResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'KADERISASI';

    protected static ?string $pluralModelLabel = 'Daftar KADERISASI';
                            ...
                            Card::make()
                                ->schema([
                                    ...
                                    Forms\Components\TextInput::make('title')
                                        ->label('Judul Program')
                                        ->maxLength(255)
                                        // ->default(fn($livewire) => $livewire instanceof \Filament\Resources\Pages\CreateRecord ? 'Program KADERISASI' : null)
                                        // ->live(onBlur: true)
